...
const ParticleSizeCards = () => {
  ...
  return (
    <>
      {/* Google Fonts Link for Teko and Rubik */}
      <link 
        href="https://fonts.googleapis.com/css2?family=Teko:wght@300;400;500;600;700&family=Rubik:wght@300;400;500;600;700&display=swap" 
        rel="stylesheet" 
      />
            ...
            >
              <div className="flex min-h-[739px] flex-col lg:flex-row">
                ...
                <div className="flex-1 p-8 lg:p-12 xl:p-16">
                  <h1 
                    className="text-[44px] md:text-[56px] lg:text-[72px] font-normal uppercase leading-none tracking-tight text-[#CF8700]"
                  ...
                  <h2 
                    className="mt-6 text-[26px] md:text-[34px] lg:text-[44px] font-normal uppercase leading-tight text-black"
                    style={{ fontFamily: 'Teko, sans-serif' }}
                  >
                    {currentData.title}
                  </h2>
                  ...
                  <p 
                    className="mt-4 max-w-[520px] text-[16px] md:text-[18px] leading-7 md:leading-8 text-black"
                  ...
                  <div className="mt-10 flex flex-wrap items-start gap-10 lg:gap-12">
                    <div className="text-left">
                      <div 
                        className="text-3xl lg:text-4xl xl:text-5xl font-normal text-gray-900"
                        style={{ fontFamily: 'Teko, sans-serif' }}
                      >
                        {currentData.yieldRate}
                      </div>
                      <div 
                        className="mt-1 text-[11px] font-normal uppercase tracking-wide text-gray-600"
                        style={{ fontFamily: 'Teko, sans-serif' }}
                      >
                        YIELD RATE
                      </div>
                    ...
                    <div className="text-left">
                      ...
                      <div 
                        className="mt-1 text-[11px] font-normal uppercase leading-4 tracking-wide text-gray-600"
                        style={{ fontFamily: 'Teko, sans-serif' }}
                      >
                        BATCH OF
                        <br />
                  ...
                  {/* CTA */}
                  <button 
                    className="mt-8 inline-flex h-[56px] items-center justify-center rounded-[4px] bg-[#CF8700] px-8 text-[16px] font-normal uppercase tracking-wide text-white transition-colors hover:bg-[#B8770A]"
                    style={{ fontFamily: 'Teko, sans-serif' }}
                  >
                    Learn More &gt;
                  </button>
                  ...
                  {currentData.grades.map((step, index) => (
                    ...
                    >
                      <div className="flex h-16 items-center rounded-[30px] border-2 border-[#CF8700] bg-white px-6">
                        <span 
                          className="text-[14px] font-normal uppercase text-black"
                          style={{ fontFamily: 'Teko, sans-serif' }}
                        >
                          {step.name}
                        </span>
